...
{
	public class FileDiffControlCommands : CommandContainer
	{
		private OpenFileInExternalEditorCommand _openFileInExternalEditor;

		private CopyCommand _copy;

		private CopyAsPatchCommand _copyAsPatch;
		...
		public CopyAsPatchCommand CopyAsPatch => CommandContainer.Lazy(ref _copyAsPatch);
